...
public class PassengerTest {
    ...
    @DisplayName("GIVEN FIRST NAME 'Rory' AND LAST NAME 'Gilmore' THEN RETURN 'Gilmore,Rory'")
    @Test
    void testFullIDWithMoreThanOneName() {
        Passenger passenger = new Passenger("Rory", "Gilmore");
        String output = passenger.fullID();
        assertEquals("Gilmore,Rory", output);
    }

    @DisplayName("GIVEN SINGLE NAME 'Gilmore' THEN RETURN 'Gilmore'")
    @Test
    void testFullIDWithSingleName() {
        Passenger passenger = new Passenger("Gilmore");
        String output = passenger.fullID();
        assertEquals("Gilmore", output);
    }
